 ...
 * </p>
 */
@ComponentScan(basePackages = { "org.eclipse.hono.service", "org.eclipse.hono.deviceregistry", "iot.core.hono.device.registry" })
@Configuration
...
public class Application extends AbstractApplication {
    ...
    private Future<String> deployCredentialsService() {
        ...
        if (this.credentialsService != null) {
            ...
            getVertx().deployVerticle(this.credentialsService, result.completer());
        } else {
            result.complete();
        }
        return result;
    ...
    private Future<String> deployAuthenticationService() {
        ...
        if (!Verticle.class.isInstance(this.authenticationService)) {
            ...
            getVertx().deployVerticle((Verticle) this.authenticationService, result.completer());
        }
        return result;
    }
    ...
    private Future<String> deployRegistrationService() {
        ...
        final Future<String> result = Future.future();
        getVertx().deployVerticle(this.registrationService, result.completer());
        return result;
    }
