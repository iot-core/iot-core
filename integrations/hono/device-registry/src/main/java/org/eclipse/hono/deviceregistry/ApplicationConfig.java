...
import org.eclipse.hono.deviceregistry.endpoint.CredentialsHttpEndpoint;
...
public class ApplicationConfig {
    ...
    @Bean
    @Scope("prototype")
    public org.eclipse.hono.deviceregistry.endpoint.CredentialsHttpEndpoint credentialsHttpEndpoint() {
